...
const LogIn = () => {
  ...
  return (
    <>
      ...
      {success && (
        <div className="flex absolute top-0 right-0 z-10 rounded-lg shadow-lg md:w-1/4 p-4 m-2 bg-green-500 sm:w-auto">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="stroke-current shrink-0 h-6 w-6 mr-2"
            fill="none"
          ...
          <div className="max-w-md w-full p-6">
            ...
            <form className="space-y-4" onSubmit={handleLogin}>
              <div>
                <label
                  type="email"
                  className="block text-md font-medium text-gray-700 after:content-['*'] after:ml-0.5 after:text-red-500"
                >
                  Email
                </label>
                <input
